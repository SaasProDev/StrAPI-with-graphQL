<template>
  <div>
      ...
      <div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@m uk-margin" v-for="(restaurant, index) in filteredList" v-bind:key="`restaurant-${index}`" uk-grid>
